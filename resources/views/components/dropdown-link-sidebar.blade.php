...
<details class="{{ $type }} [&_summary::-webkit-details-marker]:hidden">
    <summary {{ $attributes->merge(['class' => $classes]) }}>
        <div class="flex items-center gap-3">
            {{ $menu }}
        </div>

        <span class="shrink-0 transition duration-300 {{ $type }}-open">
